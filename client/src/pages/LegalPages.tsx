...
const enPrivacy = <>
  ...
  <h2>3. Analytics</h2><p>We currently use Google Analytics to understand aggregate website usage. We are not currently displaying third-party advertising. Analytics services may use cookies or similar technologies under their own policies. If our advertising practices change, this policy will be updated before or when those practices begin.</p>
...
const arPrivacy = <>
  ...
  <h2>٣. التحليلات</h2><p>نستخدم حالياً Google Analytics لفهم استخدام الموقع بشكل إجمالي. لا نعرض حالياً إعلانات من جهات خارجية. قد تستخدم خدمات التحليلات ملفات تعريف الارتباط أو تقنيات مشابهة وفقاً لسياساتها الخاصة. إذا تغيرت ممارساتنا الإعلانية، فسنحدّث هذه السياسة قبل بدء تلك الممارسات أو عند بدء تطبيقها.</p>
