...
function BrandMark({ compact = false }: { compact?: boolean }) {
  return (
    <span className={compact ? "brand-lockup brand-lockup--compact" : "brand-lockup"}>
      <img src={images.mark} alt="AURELIS mark" className="brand-mark" />
    ...
    <div className={`site-shell ${isArabic ? "site-shell--rtl" : ""}`}>
      {isLoading && (
        <div className="preloader" aria-live="polite">
          <img src={images.mark} alt="" className="preloader-mark" />
          <div className="preloader-line"><span /></div>
          <span className="preloader-label">AURELIS / 2026</span>
        </div>
      )}
